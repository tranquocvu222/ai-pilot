...
- **Display:** Real-time, badge/counter, notification center.
...
- **Mobile/Web App:** Short message, deep link to task.
- **Configurable:** Users can enable/disable per device.
...
- **Push Token Validation:** Device tokens must be valid and current.
- **Content Validation:** No PII leakage, proper escaping of user-generated content.
