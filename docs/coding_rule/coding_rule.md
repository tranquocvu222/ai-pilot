...
- Follow **clean and semantic HTML** structure using Thymeleaf.
- Keep template files **modular and reusable** (use fragments where possible).
- Use **th:object** and **th:field** correctly when working with forms.
- Maintain consistency with existing Thymeleaf templates in the project.
- Avoid placing business logic or conditional statements in the templates.
- Write templates that are **easy to read and maintain**.
- Ensure all frontend code aligns with the UI/UX conventions of the project.
- Keep styling minimal in the HTML—delegate visual styles to CSS where appropriate.
